...
class ScenarioWriter:
    ...
    def write(self, rate: float):
        ...
        # firestation書き出し
        for building_id in self.choice_buildings(0, int(1 * rate)):
        ...
        # hydrant書き出し
        for road_id in self.choice_roads(0, int(1 * rate)):
        ...
        # fire書き出し
        for fire_id in self.choice_buildings(1, int(2 * rate)):
        ...
        # civilian書き出し
        for agent_id in self.choice_agents(1, int(5 * rate)):
        ...
        # firebrigade書き出し
        for agent_id in self.choice_agents(1, int(3 * rate)):
