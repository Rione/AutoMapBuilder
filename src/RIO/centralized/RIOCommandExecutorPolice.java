    ...
    public RIOCommandExecutorPolice(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
        ...
        switch  (scenarioInfo.getMode()) {
            case PRECOMPUTATION_PHASE:
                this.pathPlanning = moduleManager.getModule("CommandExecutorPolice.PathPlanning", "RIO.module.algorithm.AstarPathPlanningPolice");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorPolice.ActionExtClear", "RIO.extaction.RIOActionExtClear");
                this.actionExtMove = moduleManager.getExtAction("CommandExecutorPolice.ActionExtMove", "RIO.extaction.RIOActionExtMove");
                break;
            case PRECOMPUTED:
                this.pathPlanning = moduleManager.getModule("CommandExecutorPolice.PathPlanning", "RIO.module.algorithm.AstarPathPlanningPolice");
                this.actionExtClear = moduleManager.getExtAction("CommandExecutorPolice.ActionExtClear", "RIO.extaction.RIOActionExtClear");
