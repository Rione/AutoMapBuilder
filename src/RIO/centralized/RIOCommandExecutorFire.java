...
public class RIOCommandExecutorFire extends CommandExecutor<CommandFire> {
	...
	public RIOCommandExecutorFire(AgentInfo ai, WorldInfo wi, ScenarioInfo si, ModuleManager moduleManager, DevelopData developData) {
		...
		case PRECOMPUTATION_PHASE:
			this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "RIO.module.algorithm.AstarPathPlanning");
			this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ActionFireFighting", "RIO.extaction.RIOCommandActionFireFighting");
			this.actionExtMove = moduleManager.getExtAction("CommandExecutorFire.ActionExtMove", "RIO.extaction.RIOActionExtMove");
			break;
		case PRECOMPUTED:
			this.pathPlanning = moduleManager.getModule("CommandExecutorFire.PathPlanning", "RIO.module.algorithm.AstarPathPlanning");
			this.actionFireFighting = moduleManager.getExtAction("CommandExecutorFire.ActionFireFighting", "RIO.extaction.RIOCommandActionFireFighting");
	...
	public CommandExecutor calc() {
		...
		case ACTION_EXTINGUISH:
			...
			/*if(this.target != null&&this.actionFireFighting.setTarget(this.target).calc()!=null) {
				this.result = this.actionFireFighting.setTarget(this.target).calc().getAction();
			}*/
			return this;
		case ACTION_REFILL:
