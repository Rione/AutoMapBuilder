...
public class RIOActionFireFighting extends ExtAction
{
	...
	public RIOActionFireFighting(AgentInfo agentInfo, WorldInfo worldInfo, ScenarioInfo scenarioInfo, ModuleManager moduleManager, DevelopData developData)
	{
		...
		case PRECOMPUTATION_PHASE:
			this.pathPlanning = moduleManager.getModule("ActionFireFighting.PathPlanning", "RIO.module.algorithm.AstarPathPlanning");
			this.clustering = moduleManager.getModule("RIOActionFireFighting.Clustering.Fire", "RIO.module.algorithm.RioneKmeansPP");
			break;
		case PRECOMPUTED:
			this.pathPlanning = moduleManager.getModule("ActionFireFighting.PathPlanning", "RIO.module.algorithm.AstarPathPlanning");
			this.clustering = moduleManager.getModule("RIOActionFireFighting.Clustering.Fire", "RIO.module.algorithm.RioneKmeansPP");
